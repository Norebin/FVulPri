...
class SingleNodeAttentionLayer(nn.Module):
    ...
    def __init__(self, in_features, out_features, dropout, alpha, concat=True):
        ...
        self.Wo = nn.Parameter(torch.empty(size=(4*out_features, out_features)).to(device))
    ...
    def forward(self, features): 
        ...
        W1_features = W1_features.to(device)
        ...
        weighted_node_feature_multi = torch.cat([weighted_node_feature1, weighted_node_feature3], dim=1)
